...
namespace Lists
{
    ...
    public class DoublyLinkedListTest
    {
        ...
        public void InsertBeforeTest()
        {
            ...
            testList.InsertBeginning(thirdNode);
            testList.InsertBefore(thirdNode, secondNode);
            testList.InsertBefore(secondNode, firstNode);

            Assert.That(testList.head == firstNode);
            Assert.That(testList.head.Next == secondNode);
            Assert.That(testList.head.Next.Next == thirdNode && testList.tail == thirdNode);
        }
        ...
        public void RemoveBeforeTest()
        {
            ...
            // testList.RemoveBefore(thirdNode);

            // Assert.That(testList.head.Next == thirdNode);
            // Assert.That(testList.tail == thirdNode);
            // Assert.That(testList.Size == 2);
        }
